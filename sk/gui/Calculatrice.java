...
public class Calculatrice extends JInternalFrame {
    ...
    //private JInternalFrame this; // Main this
    ...
    */
    ...
    public Calculatrice() {
        //this = new JFrame("Calculator");
        //this = this;
        

        this.setSize(WINDOW_WIDTH, WINDOW_HEIGHT);
        //this.setLocationRelativeTo(null); // Move this to center

        this.setClosable(true);
        
        //this.setDefaultCloseOperation(fentre.EXIT_ON_CLOSE);
        ...
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); // Close button clicked? = End The process
    ...
    private Consumer<ItemEvent> calcTypeSwitchEventConsumer = event -> {
        ...
        switch (selectedItem) {
            case "Standard":
                ...
                break;
            case "Scientific":
                this.setSize(WINDOW_WIDTH + 80, WINDOW_HEIGHT);
